...
import { policiesService, POLICY_DEFS } from "@/lib/policies";

/**
 * Public policy page — renders saved HTML for a given slug.
...
const PolicyPage = ({ slug }) => {
  ...
  useEffect(() => {
    ...
    // TODO: API INTEGRATION -> GET /api/policies/{slug}
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-10 sm:py-14 max-w-4xl">
          <header className="mb-8">
            ...
            <h1 className="font-display font-bold text-3xl sm:text-4xl text-foreground">{def?.title}</h1>
          </header>
